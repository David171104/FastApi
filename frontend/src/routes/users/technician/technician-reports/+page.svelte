                ...
                <tbody>
                    {#each reports as r, i}
                        <tr>
                            ...
                            <td><span class="service-id">#{r[1]}</span></td>
                            <td><span class="description">{r[2]}</span></td>
                            <td><span class="duration">{r[3]}</span></td>
                            <td class="text-right">
                                <button class="btn-pdf" on:click={() => showReport(r[0])} title="Descargar PDF">
